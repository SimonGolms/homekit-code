...
describe('isPairingCode', () => {
  ...
  test('its not a pairingCode', () => {
    ...
    ['false', 'true', 'NaN', '[]', '{}', '1a', '1', '12', '123', '1234', '12345', '123456', '1234567', '123456789', '123-45-678'].map(
      (number) => {
